...
bool IPCtrl::setText(const QString &strIP)
{
    ...
    else
    {
        ...
        {
            m_pLineEdit[i]->setText(ipList[i]);
        }
    }
...
bool IPCtrl::isTextValid(const QString &strIP)
{
...
QString IPCtrl::text()
{
    ...
    for (int i = 0; i < 3; i++)
    {
        strIP.append(m_pLineEdit[i]->text());
        strIP.append(".");
    }
    strIP.append(m_pLineEdit[3]->text());
